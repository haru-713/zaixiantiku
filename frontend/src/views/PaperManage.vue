  ...
  <div class="paper-page">
    ...
    <el-dialog v-model="manualVisible" :title="editingId ? '修改试卷' : '手动组卷'" width="900px">
      <el-form :model="manualForm" label-width="90px">
        ...
        <el-form-item label="总分">
          <el-input-number v-model="manualForm.totalScore" :min="0" />
        </el-form-item>
        ...
        <div class="question-selection">
          ...
          <div class="selection-actions">
            <el-button type="primary" size="small" :disabled="!manualForm.courseId" @click="openQuestionPicker">选择题目</el-button>
          </div>
          <el-table :data="manualForm.questions" size="small" border style="margin-top: 10px">
            ...
            <el-table-column label="分值" width="100">
              <template #default="scope">
                <el-input-number v-model="scope.row.score" :min="1" size="small" style="width: 80px" @change="calculateTotalScore" />
              </template>
            </el-table-column>
            <el-table-column label="排序" width="80">
              <template #default="scope">
                <el-input-number v-model="scope.row.sortOrder" :min="1" size="small" :controls="false" style="width: 60px" />
              </template>
            </el-table-column>
    ...
    <el-dialog v-model="pickerVisible" title="选择题目" width="800px" append-to-body>
      <div class="picker-search">
        <el-input v-model="pickerQuery.keyword" placeholder="题目内容关键字" style="width: 200px; margin-right: 10px" @keyup.enter="fetchPickerList" />
        <el-button type="primary" @click="fetchPickerList">查询</el-button>
      </div>
      <el-table :data="pickerList" v-loading="pickerLoading" style="margin-top: 10px" @selection-change="handlePickerSelection">
...
const calculateTotalScore = () => {
  manualForm.totalScore = manualForm.questions.reduce((sum, q) => sum + (q.score || 0), 0)
}
